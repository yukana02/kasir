              ...
              <div class="row">
                  <div class="col-lg-12 main-chart">
						...
						<!-- Trigger the modal with a button -->
								...
								<button type="button" class="btn btn-primary btn-md pull-right col-12 " data-toggle="modal" data-target="#myModal">
									<i class="fa fa-plus"></i> Insert Data</button>
								<a href="index.php?page=barang&stok=yes" style="margin-right :0.5pc;" 
									class="btn btn-warning btn-md pull-right col-12 ">
									<i class="fa fa-list"></i> Sortir Stok Kurang</a>
								<a href="index.php?page=barang" style="margin-right :0.5pc;" 
									class="btn btn-success btn-md pull-right col-12 ">
								...
								?>
									<tr>
										...
										<td>
											...
											<?php }else{?>
											<a href="index.php?page=barang/details&barang=<?php echo $isi['id_barang'];?>"><button class="btn btn-primary btn-xs col-12">Details</button></a>
										
											<a href="index.php?page=barang/edit&barang=<?php echo $isi['id_barang'];?>"><button class="btn btn-warning btn-xs col-12">Edit</button></a>
											<a href="fungsi/hapus/hapus.php?barang=hapus&id=<?php echo $isi['id_barang'];?>" onclick="javascript:return confirm('Hapus Data barang ?');"><button class="btn btn-danger btn-xs col-12">Hapus</button></a>
											<?php }?>
						...
						<!-- css responsive table, mentembuyikan beberap item saat ukuran layar mengecil -->
						<style>
							@media (max-width: 768px) {
							/* Mengatur tampilan hanya pada layar dengan lebar maksimum 768px (ukuran layar mobile) */
							.modal-view table th:nth-child(2),
							.modal-view table td:nth-child(2) {
								display: none; /* Sembunyikan kolom id barang */
							}

							.modal-view table th:nth-child(3),
							.modal-view table td:nth-child(3) {
								display: none; /* Sembunyikan kolom Harga kategori */
							} 
							.modal-view table th:nth-child(5),
							.modal-view table td:nth-child(5) {
								display: none; /* Sembunyikan kolom merek */
							} 
							.modal-view table th:nth-child(7),
							.modal-view table td:nth-child(7) {
								display: none; /* Sembunyikan kolom Harga Beli */
							} 
							.modal-view table th:nth-child(9),
							.modal-view table td:nth-child(9) {
								display: none; /* Sembunyikan kolom satuan */
							} 
							tfoot th {
								display: none; /* Sembunyikan elemen dengan colspan 5 */
							}
							}
